...
module.exports = function(server, config, log) {
    ...
    class BaseModel {
        ...
        static list(options) {
            ...
            return _parseFilter(this, options.filter).then(this.callHandler('pre-list')).then((query) => {
                ...
                }).then(this.callHandler('post-list'));
            });
        ...
        static show(id, options) {
            ...
            var q = {};
            q[this.idField] = id;
            return this.callHandler('pre-show')(q).then(function(q) {
            ...
            }).then(this.callHandler('post-show'));
        }
        ...
        save(data, options) {
            ...
            if(val.error) {
                ...
                var fieldsToUpdate = _.omitBy(existing, function (val, key) {
