...
module.exports = function(server, config, log) {
    ...
    class BaseModel {
        ...
        static list(options) {
            ...
            return _parseFilter(this, options.filter).then(this.callStaticHandler('pre-list')).then((query) => {
                ...
                }).then(this.callStaticHandler('post-list'));
            });
        ...
        static show(id, options) {
            ...
            var q = {};
            q[this.idField] = id;
            return this.callStaticHandler('pre-show')(q).then(function(q) {
            ...
            }).then(this.callStaticHandler('post-show'));
        }
        ...
        create() {
            var _this = this;
            return this.callHandler('pre-create')(this).then(function() {
                return _this.save(null,{upsert: true});
            }).then(this.callHandler('post-create'));
        }

        update() {
            var _this = this;
            return this.callHandler('pre-update')(this).then(function(data) {
                return _this.save(data);
            }).then(this.callHandler('post-update'));
        }
        ...
        static remove(id) {
            ...
            var q= {};
            q[this.idField] = id;
            return this.callStaticHandler('pre-remove')(q).then(function(check) {
                if(check) {
                    return coll.removeOne(q);
                }
            }).then(this.callStaticHandler('post-remove'));
        }
        ...
        remove() {
            ...
            var q= {};
            q[this.constructor.idField] = this[this.constructor.idField];
            return this.callHandler('pre-remove')(q).then(function(check) {
                if(check) {
                    return coll.removeOne(q);
                }
            }).then(this.callHandler('post-remove'));
        }
