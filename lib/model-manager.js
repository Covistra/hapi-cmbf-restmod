    ...
    var _generateRoutes = P.method(function(Model) {
        ...
        routes.push({
            ...
            config: {
                ...
                auth: Model.list_auth === false ?  false : Model.list_auth || Model.auth || 'token',
                cache: Model.cache,
        ...
        routes.push({
            ...
            config: {
                ...
                tags: Model.tags || ['api'],
                auth: Model.show_auth === false ?  false : Model.show_auth || Model.auth || 'token',
                cache: Model.cache,
        ...
        routes.push({
            ...
            config: {
                ...
                tags: Model.tags || ['api'],
                auth: Model.create_auth === false ?  false : Model.create_auth || Model.auth || 'token',
        ...
        routes.push({
            ...
            config: {
                ...
                tags: Model.tags || ['api'],
                auth: Model.upsert_auth === false ?  false : Model.upsert_auth || Model.auth || 'token',
        ...
        routes.push({
            ...
            config: {
                ...
                tags: Model.tags || ['api'],
                auth: Model.update_auth === false ?  false : Model.update_auth || Model.auth || 'token',
        ...
        routes.push({
            ...
            config: {
                ...
                tags: Model.tags,
                auth: Model.delete_auth === false ?  false : Model.delete_auth || Model.auth || 'token',
